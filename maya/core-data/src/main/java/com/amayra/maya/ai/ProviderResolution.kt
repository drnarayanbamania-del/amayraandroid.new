...
object ProviderResolution {
    ...
    /** llama-3.3-70b-versatile went Enterprise-only on Groq (2026); GPT-OSS 120B is the free production replacement with native tool calling. */
     ...
     * Includes provider-namespaced slugs (Groq serves "openai/gpt-oss-120b",
     * "meta-llama/…", "qwen/…") — a bare-prefix-only list silently rejected
     * them and rewrote the user's saved model back to the default. */
    private val KNOWN_COMPAT_PREFIXES = listOf(
        "llama", "mixtral", "gemma", "qwen", "deepseek", "mistral",
        "openai/", "groq/", "meta-llama/", "minimaxai/", "canopylabs/"
    )
