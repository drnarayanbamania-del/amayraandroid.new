...
import com.amayra.maya.ui.chat.LastErrorBanner
...
fun MyraHomeScreen(app: MayaApplication) {
    ...
    Column(
        ...
        // ── AI failure banner: quota/auth/network problems surface HERE, ──
        // not just in logcat — with Retry and a jump to AI settings.
        LastErrorBanner(core = app.core)
