...
import com.amayra.maya.feature.AssistantAi
...
class SeeScreenTool : Tool {
    ...
    override suspend fun execute(args: JsonObject, ctx: ToolContext): ToolResult {
        ...
        // Vision model comes from the composition root via the feature seam —
        // this library module cannot reach the Application class directly.
        val ai: AssistantAi? = AssistantAiHolder.ai
        val answer = ai?.visionOnce(dataUrl, question)
            ?: return ToolResult.Failure(
